class mypc_pwchange_package:
    def show_mypcfile(self):
        print('\033[94m'+'1.윈도우 키를 누르고 계정관리를 검색하여 선택'+'\033[0m')
        print('\033[94m'+'2.대신 로컬 계정으로 로그인 클릭'+'\033[0m')
        print('\033[94m'+'3.다음과 같은 화면이 나오는 경우 PC지키미 조건에 맞는 암호를 설정한 후 다음을 클릭. 이후 윈도우 운영체제의 로그오프가 시작됨'+'\033[0m')
        print('\033[94m'+'4.PC지키미를 재검사 하여 안전상태로 나왔는지 확인'+'\033[0m')
